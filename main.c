...
/* USER CODE BEGIN PV */
volatile uint8_t TxBuffer[] = {"n1.val=" };
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)//inturrupt 발생시
{
	if(GPIO_Pin==GPIO_PIN_13)// 버튼 눌렀을 때
	{
		  //HAL_GPIO_WritePin(GPIOB,LD3_Pin, GPIO_PIN_SET);
		  		//HAL_Delay(2000);//0.5초 대기
