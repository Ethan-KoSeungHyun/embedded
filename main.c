...
/* USER CODE BEGIN PV */
uint8_t txBuffer[] = "\r\nThis is a message from Nucleo F746ZG\r\n"; //
uint8_t rxBuffer[10]; // Rx Buffer 10 setting
uint16_t txLen = 0; //
...
{
  rcvFlag = 1;
  HAL_UART_Transmit_DMA(&huart3, rxBuffer, 10);
}
